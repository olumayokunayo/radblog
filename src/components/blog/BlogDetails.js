    ...
    <>
      ...
      >
        <Container
          ...
          sx={{
            backgroundImage:
              "linear-gradient(to right,#e6f4e9 ,#f1fff5,#e6f4e9)",
            height: "10vh",
          }}
        ></Container>
        <Typography sx={{ marginLeft: "10%", marginTop: "1rem" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "0.3rem" }}>
            <Link to='/blog' style={{ color: "#222" }}>Blog</Link> <span>|</span>
            <Button
              onClick={backHandler}
              sx={{
                bgcolor: "none",
        ...
        <Container maxWidth="lg" sx={{ display: "flex" }}>
          <Box sx={{ flex: 2, borderRight: "1px solid black" }}>
            ...
            {/* <Typography>{blogPost.duration}</Typography> */}
            {/* <Typography>{blogPost.createdAt.seconds}</Typography> */}
          </Box>
